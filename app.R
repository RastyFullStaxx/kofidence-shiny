...
save_data = function(users, all_transactions, promos, promo_id_ctr,
  ...
  tryCatch(
    write(toJSON(payload, auto_unbox = TRUE, null = "null"), DATA_FILE),
...
load_data = function() {
  ...
  tryCatch(
    fromJSON(DATA_FILE, simplifyVector = FALSE),
...
modals_ui = tagList(
  tags$div(class="modal-overlay", id="modalTerms",
           tags$div(class="modal-box", style="max-height:80vh;overflow-y:auto;",
                    ...
                    tags$div(class="modal-body-kof",
                             tags$p(style="font-weight:600;margin-bottom:8px;", "Kofidence Cafe Advantage Card — Terms and Conditions"),
  ...
  tags$div(class="modal-overlay", id="modalPrivacy",
           tags$div(class="modal-box", style="max-height:80vh;overflow-y:auto;",
                    ...
                    tags$div(class="modal-body-kof",
                             tags$p(style="font-weight:600;margin-bottom:8px;", "Kofidence Cafe Advantage Card — Privacy Policy"),
